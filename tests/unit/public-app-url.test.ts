...
describe("public app URL for employee invitations", () => {
  ...
  it("usa a URL do deployment no Preview Vercel", () => {
    ...
    expect(getEmployeeInviteRedirectUrl(environment)).toBe("https://ponto-git-mobile-acesso-personal-prime.vercel.app/auth/definir-senha");
  ...
  it("mantém o Preview no próprio deployment mesmo se uma URL de produção tiver sido configurada por engano", () => {
    const environment = {
      NODE_ENV: "production",
      VERCEL_ENV: "preview",
      VERCEL_URL: "ponto-git-mobile-acesso-personal-prime.vercel.app",
      NEXT_PUBLIC_SITE_URL: "https://ponto.personalprime.com.br",
    };
    expect(getEmployeeInviteRedirectUrl(environment)).toBe("https://ponto-git-mobile-acesso-personal-prime.vercel.app/auth/definir-senha");
  });
  ...
  it("mantém o redirect na origem autorizada e recusa URL de deployment inválida", () => {
    ...
    expect(buildPublicAppRedirectUrl("/auth/definir-senha", environment)).toBe("https://ponto.personalprime.com.br/auth/definir-senha");
