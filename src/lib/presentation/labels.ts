const auditActions: Record<string, string> = {
  ...
  EMPLOYEE_DELETED: "Funcionário excluído definitivamente",
  ...
  EMPLOYEE_ARCHIVED: "Cadastro de funcionário desativado e arquivado",
  ...
  EMPLOYEE_MOBILE_ACCOUNT_INVITED: "Convite de acesso mobile enviado",
